        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for MeldeonPOS</h1>
                    <p class="lead">MeldeonPOS web application for business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>MeldeonPOS by <a href="http://meldeonpos.co.ke">Meldeon Technologies ltd</a>.</p>
                    </div>
                </div>
            </div>
        </div>
