            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input('total_cheques_submitted', ($_POST['total_cheques_submitted'] ?? $chsales->total_cheques), 'class="form-control input-tip" id="total_cheques_submitted" required="required"'); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                foreach ($users as $user) {
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input('total_cc_slips_submitted', ($_POST['total_cc_slips_submitted'] ?? $ccsales->total_cc_slips), 'class="form-control input-tip" id="total_cc_slips_submitted" required="required"'); ?>
                    </div>
                </div>
            </div>
